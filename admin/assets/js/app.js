...
$(document).ready(function(){
	...
	$(".close_img").click(
	  function() {
	  	...
	  	$(this).parents('.report_item').css("display","none");
	...
	$('.report_col').click(function() {
		if($(this).hasClass('report_active')){
			$(this).removeClass('report_active');
			$(this).parents('.report_item').find('.more_details').hide();	
		} else {
