...
<html class="no-js" lang="en" dir="ltr">
  <head>
    ...
    <title>Sura Images | Search </title>
  ...
  <div class="inside_body">
    ...
    <div class="large-2 columns search_bar" >
        <ul class="accordion" data-accordion>
          <li class="search_bar_item accordion-item is-active" data-accordion-item>
              ...
              <ul class="vertical menu" data-accordion-menu>
                <li>
                  ...
                  <ul class="menu vertical nested">
                    <li>
                      <select  name="" class="accordion_select">
                         <option>Select Image Type</option>
                         <option>Royalty Free</option>
                         <option>Right Managed</option>
                      </select>
                ...
                <li>
                  ...
                  <ul class="menu vertical nested">
                    <li><select class="accordion_select"><option>Contributor</option></select></li>
                  </ul>
                </li>
                ...
                <div class="search-footer">
                  ...
                  <button class="button btn-clear "> Clear </button>
                </div>
            </div>
          </li>
          <!-- ... -->
    ...
    <div class="large-10 columns pull-right search_results no-padding">
          ...
          <div class="large-12 columns">
                <div class=" search_results_img">
                  <a href="details_page.html" class="search_img">
                    <img src="assets/img/search_image.png" >
                  </a>
                  <div class="search_img_details"> 
                    <span class="search_img_title"> Sunrays Cutting Through Kinale Forest</span>
                    <span class="search_img_icons">
                        ...
                        <a href=""><img src="assets/icons/expand.png"></a>
                    </span>
                 </div>
              ...
              <div class=" search_results_img">
                  <a href="details_exclusive_page.html" class="search_img">
                    <img src="assets/img/search_image.png" >
                  </a>
                  <div class="search_img_details search_img_exclusive"> 
                      <span class="search_img_title">  Available for purchase from 5th September, 2016 </span>
                  </div>    
              </div>
              <div class=" search_results_img">
                  <img src="assets/img/search_image.png" class="search_img">
        ...
        <div class="large-12 columns">
              <div class="large-5 columns pull-left no-padding">
                  <form class="inside_search_frm">
                    <input type="text" name="search" placeholder="Forest" class="inside_search_txt">
                    <select class="inside_search_slc">
                        <option value="Images">Images</option>
